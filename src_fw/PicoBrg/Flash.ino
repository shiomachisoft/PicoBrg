...
#define FLASH_WRITE_BUF_SIZE (FLASH_PAGE_SIZE * 2)        // FLASHデータ書き込みサイズ ※ FLASH_PAGE_SIZE(256byte)の倍数とする
...
void FLASH_Write(ST_FLASH_DATA *pstFlashData)
{
    ...
    flash_range_program(FLASH_OFFSET, f_writeBuf, sizeof(f_writeBuf)); // f_writBufのサイズはFLASH_PAGE_SIZEの倍数になっている
